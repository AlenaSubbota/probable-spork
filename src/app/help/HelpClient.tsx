  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          <b>Опциональный автосинк для Boosty:</b> если у тебя на Boosty
          привязан закрытый Telegram-чат подписчиков, укажи его{' '}
          <code>chat_id</code> в настройках метода и добавь{' '}
          <a href="https://t.me/chaptifybot" className="more">@chaptifybot</a>{' '}
          участником чата. Тогда читатели смогут открывать платные главы
          в один клик — бот сам проверит, что они в чате.
        </p>
      </>
    ),
  },
