...
const QAS: QA[] = [
  ...
  },
  {
    ...
    keywords: ['монеты', 'выплаты', 'деньги', 'прибыль', 'разделить'],
    answer: (
      <>
        <p>
          Читатели покупают монеты у <b>платформы</b>. Когда тратят их на
          твою главу — система запоминает «тебе причитается N монет».
          Раз в месяц админ переводит деньгами реально — в <Link href="/admin/analytics" className="more">/admin/analytics</Link>
          наверху есть блок «К выплате».
        </p>
        <p><b>Почему через платформу, а не напрямую:</b></p>
        <ul>
          <li>Читатель пополняет один раз — тратит где хочет. Не вводит
            карту у каждого из N переводчиков.</li>
          <li>Платёжки (Tribute/Boosty/банк) подключены к платформе,
            а не лично к тебе — ты не возишься с договорами.</li>
          <li>Налоги платим централизованно.</li>
        </ul>
        <p>
          Комиссия на бета-этапе <b>0%</b>, курс <b>1 монета = 1 ₽</b>.
          После публичного запуска условия финализируем.
        </p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>
          Раз в месяц (1–5 числа) закрываем предыдущий месяц: считаем
          сколько монет купили у твоих глав, переводим деньги, помечаем
          выплаченным.
        </p>
        <p>
          Способ перевода — любой: СБП по номеру телефона, на карту,
          крипта, Tribute в обратную сторону. Напиши свои реквизиты в{' '}
          <a href="https://t.me/tenebrisverbot" className="more">@tenebrisverbot</a>.
        </p>
        <p>
          Накоплено меньше 500 ₽ — переносится на следующий месяц, чтобы не
          плодить мелкие переводы. Если нужно раньше — напиши, сделаем.
        </p>
      </>
    ),
  },
