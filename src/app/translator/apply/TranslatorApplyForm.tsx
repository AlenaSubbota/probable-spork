        ...
        <div style={{ color: 'var(--ink-mute)', marginTop: 6 }}>
          ...
          <ul style={{ margin: '6px 0 0 18px', padding: 0 }}>
            ...
            <li>
              ...
              карту с кодом в комментарии, ты в <code>/admin/subscribers</code>
              {' '}сверяешь сумму и одобряешь. <b>Автомата тут нет</b> — сумма
              важна, а Boosty API в списке подписчиков суммы донатов не отдаёт.
            </li>
            <li>
              Tribute / VK Donut / Patreon — автосинка подписок пока нет, там
              любые заявки подтверждаешь руками.
            </li>
          </ul>
        </div>
      </div>
